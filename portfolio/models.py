...
class About(models.Model):
    ...
    eng_description = models.TextField(default="No description", null=True)
    github = models.CharField(max_length=200,null=True)
    linkedin = models.CharField(max_length=200,null=True)
    telegram = models.CharField(max_length=200,null=True)
    goals = models.CharField(max_length=255,null=True)
    desc1 = models.TextField(default="No Description")
    desc2 = models.TextField(default="No Description")
    desc3 = models.TextField(default="No Description")
    desc4 = models.TextField(default="No Description")
...
class Experience(models.Model):
    ...
    finish_year = models.CharField(max_length=250)
